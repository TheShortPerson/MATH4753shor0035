#' @title My P Value
#'
#' @param t0 Calculated t-statistic for the sample being tested
#' @param xmax Upper and lower bounds of the graph (default 4)
#' @param n Number of experimental units
#' @param alpha Significance  level
#'
#' @return A plot of the t-statistic, the rejection region, and the p-value
#' @export
#'
#' @examples
