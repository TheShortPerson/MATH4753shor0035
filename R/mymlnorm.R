#' @title MyMLNorm
#'
#' @param x data values vector
#' @param mu range of possible values for the mean
#' @param sig range of possible values for the standard deviation
#'
#' @return A contour plot highlighting the mean and standard deviation for the given data values vector, assuming that the dataset is normally distributed
#' @export
#'
#' @examples
#' \dontrun{mymlnorm(x=c(10,12,13,15,12,11),mu=seq(10,15,length=1000),sig=seq(0.1,4,length=1000))}
